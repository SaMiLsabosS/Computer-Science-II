public class SlotMachine
{
    ...
    public String spin()
    {
        ...
        String reel1 = faceImage();
        String reel2 = faceImage();
        String reel3 = faceImage();
        //If all three reels match then it wins, if one or two of them don't equal then it didn't win
        if(reel1.equals(reel2) && reel2.equals(reel3) && reel1.equals(reel3))  
           setWinner(true);
        else
           setWinner(false); 
